...
static CfgLexerKeyword main_keywords[] = {
  ...
  { "encoding-mode",      KW_ENCODING_MODE, 0x0400 },
  { "strict",             KW_STRICT, 0x0400 },
  { "assume-utf8",        KW_ASSUME_UTF8, 0x0400 },
  { "utf8-with-fallback", KW_UTF8_W_FALLBACK, 0x0400 },
  { "8bit-clean",         KW_8BIT_CLEAN, 0x0400 },
